                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                        ...
                        <div class="flex items-center gap-3">
                            @can('export-product')
                                <button type="button" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 shadow-sm transition">
                                    Export Product
                                </button>
                            @endcan
